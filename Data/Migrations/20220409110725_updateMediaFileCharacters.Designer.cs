...
namespace MyMDB.Data.Migrations
{
    ...
    [Migration("20220409110725_updateMediaFileCharacters")]
    partial class updateMediaFileCharacters
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CastCrewMemberMediaFile", b =>
                {
                    b.Property<int>("CastCrewMembersId")
                        .HasColumnType("int");

                    b.Property<int>("MediaFilesId")
                        .HasColumnType("int");

                    b.HasKey("CastCrewMembersId", "MediaFilesId");

                    b.HasIndex("MediaFilesId");

                    b.ToTable("CastCrewMemberMediaFile");
                });

            modelBuilder.Entity("CharacterMediaFile", b =>
                {
                    ...
                    b.HasKey("CharactersId", "MediaFilesId");
            ...
            modelBuilder.Entity("CastCrewMemberMediaFile", b =>
                {
                    b.HasOne("MyMDB.Models.CastCrewMember", null)
                        .WithMany()
                        .HasForeignKey("CastCrewMembersId")
