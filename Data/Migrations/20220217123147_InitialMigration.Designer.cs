...
namespace MyMDB.Data.Migrations
{
    ...
    [Migration("20220217123147_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyMDB.Models.ProductionRole", b =>
                {
                    ...
                    b.Property<int?>("CastCrewMemberId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyMDB.Models.Character", b =>
                {
                    b.HasOne("MyMDB.Models.CastCrewMember", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("MyMDB.Models.Fact", b =>
                {
                    ...
                    b.HasOne("MyMDB.Models.FactType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("MyMDB.Models.Movie", b =>
                {
                    ...
                    b.HasOne("MyMDB.Models.Rating", "Rating")
                        .WithMany()
            ...
            modelBuilder.Entity("MyMDB.Models.ProductionRole", b =>
                {
                    b.HasOne("MyMDB.Models.CastCrewMember", "CastCrewMember")
                        .WithMany()
                        .HasForeignKey("CastCrewMemberId1");
